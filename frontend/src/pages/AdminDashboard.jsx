...
import {Users, UserPlus,Activity,Trash2,search,ArrowLeft} from "lucide-react";
...
export default function AdminDashboard () {
    ...
    return (
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-100 dark:from-slate-950 dark:to-slate-900">
            {/* Header */}
